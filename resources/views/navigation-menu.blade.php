                ...
                @auth
                    <div class="absolute inset-x-0 bottom-0 space-y-2 px-4 py-2">
                        ...
                        <button id="dropdownTopButton" data-dropdown-toggle="dropdownTop" data-dropdown-placement="top"
                            class="inline-flex w-full items-center" type="button">
                            <div class="flex items-center gap-2">
                                ...
                                <svg class="size-2.5 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div id="dropdownTop" class="z-10 hidden w-full divide-y px-4">
