    ...
    <div x-data="{ open: false }">
        ...
        <div x-show="open" class="fixed inset-0 z-50 flex md:hidden" role="dialog" aria-modal="true">
            ...
            <div class="relative flex w-full max-w-fit flex-1 flex-col bg-white/30 text-white backdrop-blur-md">
                <div class="h-0 flex-1 space-y-8 overflow-y-auto p-4">
                    ...
                    <div>
                        <button type="button"
                            class="ml-auto flex h-10 w-10 items-center justify-center rounded-md border-2 border-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                            @click="open = !open">
                            ...
                            <div class="absolute inset-x-0 bottom-0 space-y-2 p-4">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                        ...
                                        <svg class="mr-4 h-6 w-6 flex-shrink-0 text-red-500"
        ...
        <div x-show="!open" class="absolute flex flex-1 flex-col">
            <div class="sticky top-0 z-10 py-4 pl-4">
                <button type="button"
                    class="-ml-0.5 -mt-0.5 inline-flex h-12 w-12 items-center justify-center rounded-md bg-custom-ube text-white"
                    @click="open = !open">
